...
def NHS_BASS_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_BASS_CCG_scraper still to be written')

def NHS_BANE_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_BANE_CCG_scraper still to be written')
...
def NHS_BLACK_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_BLACK_CCG_scraper still to be written')
...
def NHS_BNSSG_CCG_scraper(ccg_df, ccg_data_path):
...
def NHS_BUCK_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_BUCK_CCG_scraper still to be written')
...
def NHS_BROM_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_BROM_CCG_scraper still to be written')
...
def NHS_CANN_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_CANN_CCG_scraper still to be written')
...
def NHS_CSR_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_CSR_CCG_scraper still to be written')
...
def NHS_CAR_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_CAR_CCG_scraper still to be written')
...
def NHS_DAD_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_DAD_CCG_scraper still to be written')


def NHS_DEV_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_DEV_CCG_scraper still to be written')
...
def NHS_DORS_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_DORS_CCG_scraper still to be written')
...
def NHS_EBERK_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_EBERK_CCG_scraper still to be written')
...
def NHS_EHF_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
...
def NHS_ERE_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_ERE_CCG_scraper still to be written')
...
def NHS_FW_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_FW_CCG_scraper still to be written')
...
def NHS_GAW_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_GAW_CCG_scraper still to be written')
...
def NHS_HAF_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_HAF_CCG_scraper still to be written')


def NHS_HARDW_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_HARDW_CCG_scraper still to be written')
...
def NHS_HWLH_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_HWLH_CCG_scraper still to be written')
...
def NHS_LEE_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_LEE_CCG_scraper still to be written')
...
def NHS_NAS_CCG_scraper(ccg_df, ccg_data_path):
    try:
        ...
        # needs updating over time to be more flexible
        for pagenumber in ['201920', '201819', '201718', '201617', '201516']:
            get_all_files_one_page(url+str(pagenumber), finalepath,
                                   base_url, exceptions=[])
        parse_wrapper(ccg_data_path, filepath, abrev)
    except Exception as e:
        module_logger.debug(abrev + ' fails entirely: ' + str(e))
...
def NHS_NDER_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_LEE_CCG_scraper still to be written')
...
def NHS_NEWD_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_NEWD_CCG_scraper still to be written')
...
def NHS_OXFO_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_OXFO_CCG_scraper still to be written')
...
def NHS_RICH_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_RICH_CCG_scraper still to be written')
...
def NHS_SAWD_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SAWD_CCG_scraper still to be written')


def NHS_SCAR_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SCAR_CCG_scraper still to be written')
...
def NHS_SOME_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SOME_CCG_scraper still to be written')
...
def NHS_SDAT_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SDAT_CCG_scraper still to be written')


def NHS_SESASP_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SESASP_CCG_scraper still to be written')
...
def NHS_SKC_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SKC_CCG_scraper still to be written')
...
def NHS_SWAR_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SWAR_CCG_scraper still to be written')


def NHS_SWL_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SWL_CCG_scraper still to be written')


def NHS_SWOR_CCG_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SWOR_CCG_scraper still to be written')
...
def NHS_SDER_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_HARDW_CCG_scraper still to be written')
...
def NHS_SWARK_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SWARK_CCG_scraper still to be written')
...
def NHS_SUTT_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_SUTT_CCG_scraper still to be written')
...
def NHS_TRAF_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_TRAF_CCG_scraper still to be written')
...
def NHS_WAND_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_WAND_CCG_scraper still to be written')
...
def NHS_WARN_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_WARN_CCG_scraper still to be written')
...
def NHS_WESS_CLR_scraper(ccg_df, ccg_data_path):
    ''' not yet written'''
    module_logger.debug('NHS_WESS_CCG_scraper still to be written')
...
def scrape_ccg(ccg_df):
    ...
    ccg_data_path = os.path.abspath(
                    os.path.join(__file__, '../..', 'data', 'data_nhsccgs',
                                 'raw'))
    for scraper in ccg_df['ccg_abrev'].tolist()[145:]:
        try:
            globals()[scraper+'_scraper'](ccg_df, ccg_data_path)
        except Exception as e:
